...
-A INPUT -p tcp -m multiport --dports 81,1723,22,44158 -j ACCEPT
...
-A PREROUTING  -i eth0 -p tcp --dport 40001 -j DNAT --to-destination ${iprange}.2:8291
-A PREROUTING  -i eth0 -p tcp --dport 40002 -j DNAT --to-destination ${iprange}.3:8291
COMMIT
EOF
